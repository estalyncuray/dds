...
public class MyTopicDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements MyTopicDataWriter
{
    ...
    public MyTopicDataWriterImpl(com.example.MyTopicTypeSupport ts)
    {
        typeSupport = ts;
