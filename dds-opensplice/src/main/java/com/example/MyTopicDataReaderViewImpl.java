...
public class MyTopicDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements MyTopicDataReaderView
{
    ...
    public MyTopicDataReaderViewImpl(com.example.MyTopicTypeSupport ts)
    {
        typeSupport = ts;
