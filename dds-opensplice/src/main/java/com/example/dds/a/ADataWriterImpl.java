...
public class ADataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ADataWriter
{
    ...
    public ADataWriterImpl(com.example.dds.a.ATypeSupport ts)
    {
        typeSupport = ts;
