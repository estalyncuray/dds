...
public class ADataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ADataReaderView
{
    ...
    public ADataReaderViewImpl(com.example.dds.a.ATypeSupport ts)
    {
        typeSupport = ts;
