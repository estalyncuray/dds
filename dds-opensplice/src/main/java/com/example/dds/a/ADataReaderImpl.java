...
public class ADataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ADataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private ATypeSupport typeSupport;

    public ADataReaderImpl(com.example.dds.a.ATypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new ADataReaderViewImpl(typeSupport);
    }
}
