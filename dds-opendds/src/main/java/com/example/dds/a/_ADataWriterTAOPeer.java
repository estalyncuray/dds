...
public class _ADataWriterTAOPeer extends i2jrt.TAOLocalObject implements ADataWriter {
  protected _ADataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(com.example.dds.a.A instance);

  public native int register_instance_w_timestamp(com.example.dds.a.A instance, DDS.Time_t timestamp);

  public native int unregister_instance(com.example.dds.a.A instance, int handle);

  public native int unregister_instance_w_timestamp(com.example.dds.a.A instance, int handle, DDS.Time_t timestamp);

  public native int write(com.example.dds.a.A instance_data, int handle);

  public native int write_w_timestamp(com.example.dds.a.A instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(com.example.dds.a.A instance_data, int instance_handle);

  public native int dispose_w_timestamp(com.example.dds.a.A instance_data, int instance_handle, DDS.Time_t source_timestamp);
