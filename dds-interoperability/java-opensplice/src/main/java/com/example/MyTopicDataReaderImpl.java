...
public class MyTopicDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements MyTopicDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private MyTopicTypeSupport typeSupport;

    public MyTopicDataReaderImpl(com.example.MyTopicTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            com.example.MyTopicSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            com.example.MyTopicHolder received_data,
    ...
    */
    ...
    {
        return new MyTopicDataReaderViewImpl(typeSupport);
    }
}
